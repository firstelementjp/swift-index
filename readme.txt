...
Donate link: https://paypal.me/fejp?country.x=JP&locale.x=ja_JP
Tags: google, indexing, api, crawl, job listings
...
1.  **Upload and Install**:
	* Download the `swift-index.zip` file.
...
3.  **Initial Setup (Crucial Steps)**:
	...
	* **A. Google Cloud Platform (GCP) Setup**:
		...
		3.  **Enable the Indexing API**: In the API Library, search for "Indexing API" and enable it for your project.
...
1.  Plugin Settings Page: API Credentials and Notification Settings tabs.
2.  Plugin Settings Page: Notification Logs tab showing the list table.
3.  Post Edit Screen: Swift Index meta box displaying submission toggle and latest log.
4.  Admin Post List: Date column showing the latest API submission summary.

== Upgrade Notice ==

= 1.0.0 =
* Initial public release. Please carefully review the installation and setup instructions.
