...
namespace FirstElement\SwiftIndex\GuzzleHttp\Handler;

use FirstElement\SwiftIndex\GuzzleHttp\Exception\ConnectException;
use FirstElement\SwiftIndex\GuzzleHttp\Exception\RequestException;
use FirstElement\SwiftIndex\GuzzleHttp\Promise as P;
use FirstElement\SwiftIndex\GuzzleHttp\Promise\FulfilledPromise;
use FirstElement\SwiftIndex\GuzzleHttp\Promise\PromiseInterface;
use FirstElement\SwiftIndex\GuzzleHttp\Psr7\LazyOpenStream;
use FirstElement\SwiftIndex\GuzzleHttp\TransferStats;
use FirstElement\SwiftIndex\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx): PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \FirstElement\SwiftIndex\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri): string
    {
        ...
        $redactedUriString = \FirstElement\SwiftIndex\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \FirstElement\SwiftIndex\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \FirstElement\SwiftIndex\GuzzleHttp\Psr7\Utils::streamFor($sink);
