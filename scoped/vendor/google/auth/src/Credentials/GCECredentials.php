...
use COM;
use com_exception;
use FirstElement\SwiftIndex\Google\Auth\CredentialsLoader;
...
use FirstElement\SwiftIndex\Google\Auth\Iam;
use FirstElement\SwiftIndex\Google\Auth\IamSignerTrait;
use FirstElement\SwiftIndex\Google\Auth\ProjectIdProviderInterface;
use FirstElement\SwiftIndex\Google\Auth\SignBlobInterface;
use FirstElement\SwiftIndex\GuzzleHttp\Exception\ClientException;
...
use FirstElement\SwiftIndex\GuzzleHttp\Exception\ServerException;
