 ...
 */
namespace FirstElement\SwiftIndex\Google\Auth\Credentials;

use FirstElement\SwiftIndex\Google\Auth\CredentialSource\AwsNativeSource;
use FirstElement\SwiftIndex\Google\Auth\CredentialSource\ExecutableSource;
use FirstElement\SwiftIndex\Google\Auth\CredentialSource\FileSource;
use FirstElement\SwiftIndex\Google\Auth\CredentialSource\UrlSource;
use FirstElement\SwiftIndex\Google\Auth\ExecutableHandler\ExecutableHandler;
use FirstElement\SwiftIndex\Google\Auth\ExternalAccountCredentialSourceInterface;
use FirstElement\SwiftIndex\Google\Auth\FetchAuthTokenInterface;
use FirstElement\SwiftIndex\Google\Auth\GetQuotaProjectInterface;
use FirstElement\SwiftIndex\Google\Auth\GetUniverseDomainInterface;
use FirstElement\SwiftIndex\Google\Auth\HttpHandler\HttpClientCache;
use FirstElement\SwiftIndex\Google\Auth\HttpHandler\HttpHandlerFactory;
use FirstElement\SwiftIndex\Google\Auth\OAuth2;
use FirstElement\SwiftIndex\Google\Auth\ProjectIdProviderInterface;
use FirstElement\SwiftIndex\Google\Auth\UpdateMetadataInterface;
use FirstElement\SwiftIndex\Google\Auth\UpdateMetadataTrait;
use FirstElement\SwiftIndex\GuzzleHttp\Psr7\Request;
