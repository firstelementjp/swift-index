...
use FirstElement\SwiftIndex\Google\Auth\Credentials\ExternalAccountCredentials;
use FirstElement\SwiftIndex\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use FirstElement\SwiftIndex\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], ?callable $httpHandler = null, ?callable $tokenCallback = null)
    {
        ...
        $stack = \FirstElement\SwiftIndex\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \FirstElement\SwiftIndex\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
